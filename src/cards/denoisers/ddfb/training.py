    ...
    with torch.no_grad():
        for clean_images in val_loader:
            ...
            noisy_images, sigmas = add_noise(
                clean_images, sigma=sigma, same_noise_level=same_noise_level
            )
...
def train(
    ...
    for epoch in range(args.epochs):
        ...
        if val_loss < best_val_loss:
            ...
            #     "val_loss": val_loss,
            #     "val_input_snr": val_input_snr,
            #     "val_output_snr": val_output_snr,
            # }
...
if __name__ == "__main__":
    ...
    # python src/cards/denoisers/ddfb/training.py --data_dir /data3/mbouton/imagenet/test/ --n_layers 4 --n_features 64
