r"""DnCNN network, as described in :cite:`Zhang2017`. Implementation has been slightly adapted from the original `implementation of the authors on github <https://github.com/cszn/KAIR/blob/master/models/network_dncnn.py/>`_"""

# implementation: adapted from: https://github.com/cszn/KAIR/blob/master/models/network_dncnn.py
#
# reference: Zhang, Kai and Zuo, Wangmeng and Chen, Yunjin and Meng, Deyu and Zhang, Lei- **Beyond a Gaussian Denoiser: Residual Learning of Deep CNN for Image Denoising**, [IEEE TIP](https://ieeexplore.ieee.org/document/783918), 2017.
...
class DnCNN(nn.Module):
    def __init__(self, in_nc=3, out_nc=3, nc=64, nb=20, act_mode="R"):
        ...
        act_mode: batch norm + activation function
        # ------------------------------------
