r"""Residual U-Net (DRUNet), as described in :cite:`Zhang2021`. Implementation has been slightly adapted from the original `implementation of the authors on github <https://github.com/cszn/KAIR/blob/master/models/network_unet.py/>`_"""

# implementation: adapted from: https://github.com/cszn/KAIR/blob/master/models/network_unet.py
#
# reference: Zhang, Kai and Li, Yawei and Zuo, Wangmeng and Zhang, Lei and Van Gool, Luc and Timofte, Radu - **Plug-and-Play Image Restoration With Deep Denoiser Prior**, [IEEE PAMI](https://ieeexplore.ieee.org/abstract/document/9454311), 2021.
