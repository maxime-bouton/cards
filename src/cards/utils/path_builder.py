...
# TODO: documentation, avoid global variable PRODUCED_DATA_PATH if possible (delegate to .yml config file)
...
def sampling_dir(params: dict) -> str:
    return f"checkpoint_size{params['checkpoint_size']}-burnin{params['burnin']}-seed{params['seed']}"
