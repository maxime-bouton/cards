...
-------
BaseSampler
    Abstract contract defining the MCMC iteration loop, timing, and I/O hooks.
SerialCpuSampler
    Serial CPU implementation utilizing NumPy as the backend.
SerialGpuSampler
    Serial synchronous GPU implementation utilizing CuPy and PyTorch as the backend.
DistributedCpuSampler
    MPI-based distributed CPU implementation utilizing NumPy as the backend.
DistributedGpuSampler
    MPI-based distributed GPU implementation utilizing CuPy and PyTorch as the backend.
