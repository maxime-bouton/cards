...
def patch_extractor(x, patch_size, stride, dilation):
...
def adjoint_patch_extractor(patches, output_size, patch_size, stride, dilation):
...
if __name__ == "__main__":
    ...
    # from aaxda.utils.torch import np_to_tensor
