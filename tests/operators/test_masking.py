# import numpy as np
# import pytest
# from cards.operators.distribtued_masking import DistributedMasking
# from mpi4py import MPI

# import cards.backend as xp
# from cards.operators.masking import Masking

# FIXME: revise tests by creating propoer rng (create_rng function to use for correctness)


# @pytest.fixture
# def mask(input_shape, ctx) -> np.ndarray:
