r"""Test the paralell writting/reading of data on/from disck memory."""
...
def test_distributed_save(tmp_path, dims, seed):
    ...
    local_seed = seed + rank  #! unsafe seed
    ...
    slice = sync_comm.cartslicer._get_slice_global_buffer_to_tile()
