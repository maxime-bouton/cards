...
class TvDeconvGeometryHook:
    def build_geometry(
        ...
        slice_z1 = slice_y
        slice_z2 = G.adjoint_slice_global_buffer_to_tile if ctx.is_mpi else None

        x_shape = gt_shape
        y_shape = (*H.data_shape,)
        z1_shape = y_shape
        z2_shape = (*G.data_shape,)
        ...
        tile_z2_shape = (*G.adjoint_tile_size,) if ctx.is_mpi else z2_shape
        ...
        return TvDeconvGeometry(
            grid_shape, layout_x, layout_y, layout_z1, layout_z2, H, G, kernel_2d
        )
...
class PoissonDeconvTvMcmcHook:
    ...
    def build_model(
        ...
        model_params = PoissonDeconvolutionParams(
            obs.dynamic_range, reg_coef, split_coef1, split_coef2
        )
        ...
        if ctx.is_mpi:
            ...
            Model = PoissonDeconvolutionTvModel
